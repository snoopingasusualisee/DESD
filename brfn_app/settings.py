"""
Django settings for brfn_app project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-z%ggs^w=&tty6j_fuz04611tfxhq$4=29=j#i@3kyrs408mj4%')
...
ROOT_URLCONF = 'brfn_app.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'brfn_app' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'brfn_app.wsgi.application'
...
# Password Hashing - Use Argon2 for stronger security
PASSWORD_HASHERS = [
...
SESSION_COOKIE_SECURE = not DEBUG  # Send cookie only over HTTPS in production

# CSRF security
CSRF_COOKIE_HTTPONLY = True  # Prevent JavaScript access to CSRF cookie
CSRF_COOKIE_SAMESITE = 'Lax'
CSRF_COOKIE_SECURE = not DEBUG  # Send cookie only over HTTPS in production
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 5242880  # 5MB - matches image validator