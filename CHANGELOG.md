...
# V1.0.7 - Rob Howells
- Built out accounts app with CustomUser model and role support
- Added marketplace app with core models: Category and Product
- Created main marketplace pages/flow
- Refactored templates to use a shared stylesheet
# V1.0.8 - Rob Howells
- Created orders app
- Added models and migrations: Cart, CartItem, Order, OrderItem
- Added order URLs and views for cart actions
- Wired orders into the project
